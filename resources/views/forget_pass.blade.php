                ...
                <div class="col-md-8 ps-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    ...
                    <form class="forms-sample">
                      ...
                      <div>
                        <a href="../../dashboard.html" class="btn btn-primary me-2 mb-2 mb-md-0 text-white">Forget Password</a>
                        <a href="{{ route('login') }}" type="button" class="btn btn-outline-primary btn-icon-text mb-2 mb-md-0">
                          Sign In
                        </a>
                      </div>
