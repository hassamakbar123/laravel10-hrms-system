...
<section class="page-header">
    ...
    <!-- /.page-header__bg -->
    <div class="container">
        <h2 class="page-header__title">Tech Resources</h2>
            ...
            <div class="col-md-12 col-lg-8">
                <div class="service-details__content">
                    <div class="service-details__thumbnail">
                        <img src="assets/images/resources/service-d-2.png" alt="Tech Resources">
                    </div><!-- /.service-details__thumbnail -->
                    <h3 class="service-details__title">Tech Resources</h3><!-- /.service-details__title -->
