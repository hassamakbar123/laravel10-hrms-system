                        ...
                        <div class="col-md-12">
                            <div class="main-slider-one__content">
                                ...
                                <div class="main-slider-one__btn">
                                    <a href="{{ route('services') }}" class="hiredots-btn"><span>Discover More</span></a><!-- slider-btn -->
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                <div class="feature-one__item text-center">
                    ...
                    <div class="feature-one__item__content">
                        ...
                        <p class="feature-one__item__text">Lorem ipsum dolor sit amet sed consectur adipiscing elit.</p>
                        <a href="{{ route('news') }}" class="hiredots-btn"><span>Find Your Solution</span></a>
                    </div>
                </div><!-- feature-item -->
            </div>
            ...
            <div class="col-xl-6">
                <div class="about-one__image wow fadeInLeft" data-wow-delay="300ms">
                    <div class="about-one__image-one">
                        ...
                        <img class="about-one__image-one__shape" src="assets/images/resources/about-1-shape-1.png" alt="hiredots">
                    </div>
                    <div class="about-one__image-icon"><img src="assets/images/resources/about-1-bulb.png" alt="hiredots"></div>
            ...
            <div class="col-xl-6 wow fadeInRight" data-wow-delay="300ms">
                <div class="about-one__content">
                    ...
                    <p class="about-one__content__text">
                        ...
                        Sed risus augue, commodo ornare felis non, eleifend molestie metus pharetra eleifend.
                    </p>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="about-one__content__quote">
                                Pathway for both employer and employee. So they highly efficient manufactured products.
                            </div>
                            <div class="about-one__content__author">
                                ...
                                <div class="about-one__content__author__meta"><img src="assets/images/resources/about-sign.png" alt="hiredots">Co Founder</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="about-one__award">
                                <div class="about-one__award__content">
                                    ...
                                    <div class="about-one__award__count count-box">+<span class="count-text" data-stop="23" data-speed="1500"></span></div>
                                </div>
                                <p class="about-one__award__text">Wonderful awards</p>
                            </div>
                            <a href="{{ route('news') }}" class="hiredots-btn hiredots-btn--base"><span>Discover more</span></a>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="funfact-one__item">
                    <div class="funfact-one__icon"><span class="icon-business-idea"></span></div><!-- /.funfact-one__icon -->
                    <div class="funfact-one__count count-box"><span class="count-text" data-stop="697" data-speed="1500"></span></div><!-- /.funfact-one__count -->
                    <p class="funfact-one__text">Employer Solutions</p><!-- /.funfact-one__text -->
                </div><!-- /.funfact-one__item -->
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="funfact-one__item">
                    <div class="funfact-one__icon"><span class="icon-recruit"></span></div><!-- /.funfact-one__icon -->
                    <div class="funfact-one__count count-box"><span class="count-text" data-stop="430" data-speed="1500"></span></div><!-- /.funfact-one__count -->
                    <p class="funfact-one__text">People Job Seekers</p><!-- /.funfact-one__text -->
                </div><!-- /.funfact-one__item -->
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="funfact-one__item">
                    <div class="funfact-one__icon"><span class="icon-success"></span></div><!-- /.funfact-one__icon -->
                    <div class="funfact-one__count count-box"><span class="count-text" data-stop="98" data-speed="1500"></span>%</div><!-- /.funfact-one__count -->
                    <p class="funfact-one__text">Success Rates</p><!-- /.funfact-one__text -->
                </div><!-- /.funfact-one__item -->
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="funfact-one__item">
                    <div class="funfact-one__icon"><span class="icon-customer-review"></span></div><!-- /.funfact-one__icon -->
                    <div class="funfact-one__count count-box"><span class="count-text" data-stop="800" data-speed="1500"></span></div><!-- /.funfact-one__count -->
...
<section class="service-one" style="background-image: url(assets/images/shapes/service-bg-1.jpg);">
    <div class="container">
        <div class="sec-title text-center">
            ...
            <h3 class="sec-title__title">Outsourced Hiring & Job <br>Rules Services</h3><!-- /.sec-title__title -->
        </div><!-- /.sec-title -->
        <div class="row gutter-y-30">
                ...
                <div class="service-one-card service-card-two" data-wow-duration="1500ms" data-wow-delay="0ms">
                    ...
                    <div class="service-one-card__content">
                        <div class="service-one-card__icon">
                            ...
                            <a href="{{ route('hr-consulting') }}" class="service-one-card__cat">Management</a>
                        </div><!-- /.service-one-card__price -->
                        <h3 class="service-one-card__title">
                            <a href="{{ route('hr-consulting') }}">HR Consulting</a>
                        </h3><!-- /.service-one-card__title -->

                        <p class="service-one-card__text">Lorem ipsum dolor sit amet, consectetur notted adipisicing elit sed do eiusmod</p>
                        <!-- /.service-one-card__text -->
                    </div><!-- /.service-one-card__content -->
                    <a href="{{ route('hr-consulting') }}" class="service-one-card__link">
                        Read More
                ...
                <div class="service-one-card service-card-two" data-wow-duration="1500ms" data-wow-delay="1ms">
                    ...
                    <div class="service-one-card__content">
                        <div class="service-one-card__icon">
                            ...
                            <a href="{{route('tech-resources')}}" class="service-one-card__cat">Resources</a>
                        </div><!-- /.service-one-card__price -->
                        <h3 class="service-one-card__title">
                            <a href="{{route('tech-resources')}}">Tech Resources</a>
                        </h3><!-- /.service-one-card__title -->

                        <p class="service-one-card__text">Lorem ipsum dolor sit amet, consectetur notted adipisicing elit sed do eiusmod</p>
                        <!-- /.service-one-card__text -->
                    </div><!-- /.service-one-card__content -->
                    <a href="{{route('tech-resources')}}" class="service-one-card__link">
                        Read More
                        <i class="icon-right-arrow"></i>
                    </a><!-- /.blog-card__link -->
                </div><!-- /.service-one-card -->
                ...
                <div class="service-one-card service-card-two" data-wow-duration="1500ms" data-wow-delay="1ms">
                    ...
                    <div class="service-one-card__content">
                        <div class="service-one-card__icon">
                            ...
                            <a href="{{route('staffing-solution')}}" class="service-one-card__cat">Solution</a>
                        </div><!-- /.service-one-card__price -->
                        <h3 class="service-one-card__title">
                            <a href="{{route('staffing-solution')}}">Staffing Solution</a>
                        </h3><!-- /.service-one-card__title -->

                        <p class="service-one-card__text">Lorem ipsum dolor sit amet, consectetur notted adipisicing elit sed do eiusmod</p>
                        <!-- /.service-one-card__text -->
                    </div><!-- /.service-one-card__content -->
                    <a href="{{route('staffing-solution')}}" class="service-one-card__link">
                        Read More
                        <i class="icon-right-arrow"></i>
                    </a><!-- /.blog-card__link -->
                </div><!-- /.service-one-card -->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-xl-4 text-end wow fadeInRight" data-wow-delay="300ms">
                <a href="{{ route('news') }}" class="hiredots-btn hiredots-btn--base"><span>Discover more</span></a><!-- /.btn -->
            </div>
        </div>
            ...
            <div class="col-lg-10 col-xl-8 wow fadeInUp">
                <div class="cta-one__content">
                    ...
                    <div class="cta-one__content__list">
                        ...
                        <p class="cta-one__content__list__info">Sed non odio non elit porttit sit tincidunt.<br> Donec fermentum, elit sit amet</p>
                    </div>
    ...
    "1600": {
        ...
        <div class="item">
            <div class="project-one__card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='1ms'>
                ...
                <div class="project-one__content">
                    <span class="project-one__tagline">Resources</span>
                    <h3 class="project-one__title"><a href="{{ route('project-deatail') }}">Staffing</a></h3>
                </div>
            </div>
        </div>
        <div class="item">
            <div class="project-one__card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='1ms'>
                ...
                <div class="project-one__content">
                    <span class="project-one__tagline">Resources</span>
                    <h3 class="project-one__title"><a href="{{ route('project-deatail') }}">Tech</a></h3>
                </div>
            </div>
        </div>
        <div class="item">
            <div class="project-one__card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='1ms'>
                ...
                <div class="project-one__content">
                    <span class="project-one__tagline">Resources</span>
                    <h3 class="project-one__title"><a href="{{ route('project-deatail') }}">Consulting</a></h3>
                </div>
            </div>
        </div>
        <div class="item">
        ...
        <div class="row">
            <div class="col-lg-7 wow fadeInLeft" data-wow-delay="200ms">
                <div class="cta-two__content">
                    <div class="cta-two__sub-title"><img src="assets/images/resources/cta-2-sub-title.png" alt="hiredots"></div>
                    <h2 class="cta-two__title">Hire Your Next Candidate on Hiredots</h2>
                    <a href="{{ route('news') }}" class="hiredots-btn"><span>Discover more</span></a><!-- /.btn -->
                </div>
            </div>
            ...
            <div class="item">
                <div class="blog-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='000ms'>
                    ...
                    <div class="blog-card__content">
                        ...
                        <a href="{{ route('news') }}" class="blog-card__link">
                            Read more
                            <i class="icon-right-arrow"></i>
                        </a><!-- /.blog-card__link -->
