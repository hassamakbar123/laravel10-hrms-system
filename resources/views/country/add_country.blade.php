...
<div class=" container-fluid card-body col-mb-6">
    ...
    <form class="forms-sample" action="{{ route('store.country') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
            <label for="country_name" class="form-label">Counrty Name</label>
            <input type="text" name="country_name" class="form-control @error('country_name') is-invalid @enderror" id="grade_level" placeholder="Enter Country Name" >
            @error('country_name')
